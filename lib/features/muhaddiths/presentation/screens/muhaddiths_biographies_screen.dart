  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Directionality(
        ...
        child: muhaddithsAsync.when(
          data: (muhaddiths) {
            final sorted = [...muhaddiths]
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                final muhaddith = sorted[index];
                final about = muhaddith.about.trim().isEmpty
                    ? '-'
                    : muhaddith.about;
                final copyText = '${muhaddith.name}\n\n$about';
                ...
                return BiographyCardWidget(
                  ...
                  sectionLabel:
                      'تراجم المحدثين',
                  onShare: () {
                    Share.share(copyText, subject: muhaddith.name);
                  },
                  onCopy: () async {
